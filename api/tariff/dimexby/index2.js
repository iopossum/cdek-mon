...
var getCity = function (city, dest, country, callback) {
  ...
  var formData = "%5B%7B%22name%22%3A%22sel%5B%5D%22%2C%22value%22%3A%222%22%7D%2C%7B%22name%22%3A%22sel%5B%5D%22%2C%22value%22%3A%226%22%7D%2C%7B%22name%22%3A%22sel%5B%5D%22%2C%22value%22%3A%2219%22%7D%2C%7B%22name%22%3A%22city%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22cityo%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22countryp%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22citypp%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22cityp%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22massa%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22declarv%22%2C%22value%22%3A%22d%22%7D%2C%7B%22name%22%3A%22f_length%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22f_width%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22f_height%22%2C%22value%22%3A%22%22%7D%2C%7B%22name%22%3A%22f_cena%22%2C%22value%22%3A%22%22%7D%5D";
  ...
  opts.headers['DNT'] = '1';
  opts.headers['Host'] = 'bel.tech-dimex.ru';
  opts.headers['Origin'] = 'http://belarus.dimex.ws';
  opts.headers['Referer'] = 'http://belarus.dimex.ws/kalkulyator/';
  ...
  async.auto({
    getCountries: function (callback) {
      ...
      async.retry(config.retryOpts, function (callback) {
        ...
        options.each(function (index, item) {
          ...
          if (commonHelper.BY.indexOf(name.toLowerCase()) === -1) {
    ...
    getCities: ['getCountries', function (results, callback) {
      ...
      async.mapSeries(cities, function (city, callback) {
        ...
        if (!city.fromBy) {
          city.error = commonHelper.CITYFROMBY;
          return async.nextTick(function () {
            callback(null, city);
          });
        }
        if (!city.toBy && !results.getCountries.length) {
        ...
        setTimeout(function () {
          ...
          async.parallel([
            ...
            function (callback) {
              ...
              getCity(city.to, !city.toBy ? 'cityp' : false, countryObj[city.countryTo.toUpperCase()], callback);
            }
