...
exports.CITYTOREQUIRED = 'Должен быть указан город назначения';
...
exports.CITYFROMBY = 'Отправления возможны только из Беларуси';
exports.CITYFROMKZ = 'Отправления возможны только из Казахстана';
exports.CITYFROMORTOKZ = 'Международные отправления возможны только из Казахстана или в Казахстан';
exports.CITYFROMORTOBY = 'Международные отправления возможны только из Беларуси или в Беларусь';
